import sys
import glob
import p_median_v1 as pm1
import p_median_v2 as pm2
...
if len(myfiles) == 0:
    ...
    for p in P:
        for i in myfiles:
            ...
            for k in fichinArcs:
                pm1.optimiza(i, k, N, p, TIEMPO, CORTES, HEUR, PRE)
                pm2.optimiza(i, k, N, p, TIEMPO, CORTES, HEUR, PRE)
